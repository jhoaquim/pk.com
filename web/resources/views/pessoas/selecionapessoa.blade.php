                ...
                <a href="javascript:history.back()">
                    ...
                    <div class="btn tabs-menu">
                        ...
                        <div style="padding-bottom:10px; border-radius: 1px;">
                            ...
                            <b style='font-size: 18px;'>&nbsp;{{ $pessoas->nome }} </b>
                            </div>
                        </div>
                        ...
                        <div class="aba1 tabs tab-ativa">
                            <div class='side-a'>
                                ...
                                <div class="sombra" style="width:49%; padding-left:0px; float:left;">
                                    @if ( $pessoas->pessoa_tp === "F" )
                                        <label class="rotulo topo"><b>CPF</b></label>
                                    @else ( $pessoas->pessoa_tp === "J" )
                                        <label class="rotulo topo"><b>CNPJ</b></label>
                                    @endif
                            ...
                            <div class='side-b'>
                                ...
                                <label>
                                    ...
                                    class="campo flex justify-center items-center" id="obs" name="obs" type="textarea" placeholder="Observação" disabled>
                                    {{ $pessoas->obs }}
                                    </textarea>
                                </label>
                                <div style="width:48%; padding-left:0px; float:left;">
                                    ...
                                    <label id="last_used_at" name="last_used_at">
                                        {{ dateFormatDatabaseScreen($pessoas->last_used_at, 'screen') }}
                                    </label>
                                </div>
                        ...
                        <button id="confirmar" data-modal-target="salvar" class="retorna bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                        &nbsp;&nbsp;confirmar&nbsp;&nbsp;
                        </button>
