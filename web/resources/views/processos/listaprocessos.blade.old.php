...
@section('content')
    ...
    <!----------------------------- Modal cadProcesso ------------------------------->
    <div data-twe-modal-init draggable="true"
...
<script type="module">
    ...
    $(document).ready(function(){
            ...
            $("#requerente").on('click', function() {

                let reqId   = localStorage.getItem('requerente_id');
                let reqNome = localStorage.getItem('requerente_nome');
                if(reqId && reqNome){
                    $('#requerente').val(reqNome); // Preenche o campo visual
                    $('input[name="id"]').val(reqId); // Preenche o campo hidden
                    console.log('Campos Preenchidos Automaticamente com:', reqId, reqNome);
                    // Opcional: limpar depois de preencher
                    //limparLocalStorageRequerente();
                    //limparSessionStorageRequerente();
                }
                // Evitar que redirecione imediatamente antes do preenchimento
                setTimeout(function(){
    ...
    function limparSessionStorageRequerente() {
        ...
        console.log('sessionStorage limpo: requerente_id e requerente_nome');
    }
