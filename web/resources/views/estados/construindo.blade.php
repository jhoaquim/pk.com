        ...
        <table id='listagem' style="width:100%;">
            <thead>
                <tr>
                    ...
                    <th data-priority="2" class="bck01 campo0" style="width:20%; text-align:left;"> Nome </th>
                    <th data-priority="3" class="bck01 campo0" style="width:6%; text-align:center;"> ICMs</th>
                    <th class="bck01 campo3 esconde470" style="width:50%; text-align:center;"> Cidade </th>
                    <th class="bck01 campo4 esconde470" style="text-align:center;"> Código da Cidade  </th>
            ...
            @foreach($municipios as $municipio)
                <tr>
                    ...
                    <td id="esta_icms" name="esta_icms" style="width:6%; text-align:center;">
                        <a href="#"> {{ $municipio->esta_aliq_icms }} </a>
                    </td>

                    <td id="muni_nm" name="muni_nm" class = "esconde470" style="width:50%; text-align:left;">
