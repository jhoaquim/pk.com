...
@section('content')
    ...
    <button
        ...
        <div class="divTitulo">Lista de Estados</div>
    </button>
    </center>
            ...
            @foreach($estados as $estado)
                <tr>
                    <td id="esta_ibge" name="esta_ibge" class="registro" style="width:6%; text-align:center;">
                        <a href="javascript:alert('campo Estado IBGE')">{{ $estado->esta_ibge }}</a>
                    </td>

                    <td id="esta_uf" name="esta_uf" class="registro" style="width:6%; text-align:center;">
                        <a href="javascript:alert('campo Estado Sigla')">{{ $estado->esta_uf }}</a>
                    </td>

                    <td id="esta_nm" name="esta_nm" class = "esconde470" style="width:20%; text-align:left;">
                        <a href="#"> {{ $estado->esta_nm }} </a>
                    </td>

                    <td id="esta_icms" name="esta_icms" class = "esconde470" style="width:6%; text-align:center;">
                        <a href="#"> {{ $estado->esta_aliq_icms }} </a>
                    </td>
